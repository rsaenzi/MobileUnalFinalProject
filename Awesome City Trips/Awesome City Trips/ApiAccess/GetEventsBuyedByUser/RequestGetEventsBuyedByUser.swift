//
//  RequestGetEventsBuyedByUser.swift
//  Awesome City Trips
//
...
typealias CompletionGetEventsBuyedByUser = (_ response: ResponseGetEventsBuyedByUser) -> Void

class RequestGetEventsBuyedByUser {
    ...
    private static func handleResponse(_ resultData: Response, _ callback: @escaping CompletionGetEventsBuyedByUser) {
    ...
    private static func handleSuccess(_ jsonString: String, _ callback: @escaping CompletionGetEventsBuyedByUser) {
        
        // Converts the jsonString into a valid Object
        guard let output: OutputGetEventsBuyedByUser = jsonString.decodeFrom() else {
    ...
    private static func call(_ callback: @escaping CompletionGetEventsBuyedByUser, _ result: ResponseGetEventsBuyedByUser) {
