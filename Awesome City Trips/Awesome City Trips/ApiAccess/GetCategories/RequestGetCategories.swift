...
typealias CompletionGetCategories = (_ response: ResponseGetCategories) -> Void

class RequestGetCategories {
    
    private init() {}
    
    static func request(completion callback: @escaping CompletionGetCategories) {
    ...
    private static func handleResponse(_ resultData: Response, _ callback: @escaping CompletionGetCategories) {
    ...
    private static func handleSuccess(_ jsonString: String, _ callback: @escaping CompletionGetCategories) {
        
        // Converts the jsonString into a valid Object
        guard let output: OutputGetCategories = jsonString.decodeFrom() else {
    ...
    private static func call(_ callback: @escaping CompletionGetCategories, _ result: ResponseGetCategories) {
